...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/logoc.png" type="image/x-icon">
    <title>Campiña Tours System</title>
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="assets/css/fontawesome.css">    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="assets/css/flag-icon.css">    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="assets/css/icofont.css">    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="assets/css/prism.css">    <!-- Chartist css -->
...
<div class="page-wrapper" id="app">
    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none">
                <div class="logo-wrapper"><a href="index.html"><img class="blur-up lazyloaded" src="assets/images/logoc.png" alt=""></a></div>
            </div>
    ...
    <div class="page-body-wrapper">
        ...
        <!--Fin menu de notificaciones-->

        <!--Contenido del dasboard-->
        <div class="page-body">      
                @yield('contenido')		
        </div>
          <!--Fin del contenido del dasboard-->
